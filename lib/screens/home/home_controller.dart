...
class HomeScreenController extends State<HomeScreen> {
  ...
  StashModel get currentStash => showStash
      ? StashModel(
          id: 0,
          ...
          viewCount: 1,
          imageUrl:
              "https://images.unsplash.com/photo-1508166785545-c2dd4c113c66?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80")
      : null;
